            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Perfil de Provedor</h4>
                    </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="tab-pane fade show active" id="personal" role="tabpanel"
                                    ...
                                    <form method="POST" action="{{ route('provider.profile.update') }}"
                                        ...
                                        <div class="form-group row">
                                            <label for="profile_picture" class="col-md-4 col-form-label text-md-right">Foto
                                                de perfil</label>
                                            <div class="col-md-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('provider.profile.change-password') }}">
                                            @csrf
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            @if($user->stand)
                                                ...
                                                <div class="form-group row mb-0">
                                                    <div class="col-md-8 offset-md-4">
                                                        <a href="{{ route('provider.stands.edit', $user->stand) }}"
                                            ...
                                            @else
                                                ...
                                                <div class="text-center">
                                                    <a href="{{ route('stands.create') }}" class="btn btn-primary">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <a href="{{ route('provider.productos.create') }}" class="btn btn-primary">Añadir nuevo producto</a>
                        @endif
                    </div>
                </div>
